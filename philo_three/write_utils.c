...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/11 21:56:28 by fgoulama          #+#    #+#             */
/*   Updated: 2020/02/11 21:56:30 by fgoulama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		write_status(long timestamp, t_philosopher *philosopher, int action)
{
	...
	free(tmp);
	sem_wait(philosopher->param.write_sem);
	write(1, status, ft_strlen(status));
	sem_post(philosopher->param.write_sem);
